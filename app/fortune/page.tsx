	...
	return (
		<div className='max-w-4xl mx-auto'>
			<motion.h1
				...
				className={`text-3xl md:text-4xl font-bold mb-8 text-center text-emerald-700 ${
			...
			<AnimatePresence mode='wait'>
				{showEnvelope ? (
					...
					<motion.div
						...
						{fortune && (
							<div className='bg-white/95 rounded-xl p-6 shadow-xl mb-8 border border-amber-200'>
								<div className='mb-6'>
									<label
						...
						<div className='flex flex-col sm:flex-row justify-center gap-4 mt-8'>
							<motion.button
								...
								whileTap={{ scale: 0.95 }}
								className='bg-gradient-to-r from-red-600 to-amber-600 text-white font-bold py-3 px-6 rounded-full shadow-lg hover:from-red-700 hover:to-amber-700 transition-all duration-300'
							...
							<motion.button
								whileHover={{ scale: 1.05 }}
								whileTap={{ scale: 0.95 }}
								className='bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-bold py-3 px-6 rounded-full shadow-lg hover:from-emerald-700 hover:to-teal-700 transition-all duration-300'
...
function FortuneCard({
	...
	return (
		<motion.div
			...
			<h2
				className={`text-2xl font-semibold mb-6 text-amber-600 ${
					isRtl ? 'font-vazirmatn' : ''
				}`}>
				{title}
			</h2>
...
function FortuneAnimation() {
	return (
		<div className='relative'>
			{/* Envelope */}
			<motion.div
				className='w-40 h-40 bg-gradient-to-r from-amber-100 to-yellow-100 rounded-lg shadow-xl border border-amber-300 flex items-center justify-center relative overflow-hidden'
				animate={{
					rotateY: [0, 180, 360],
					scale: [1, 1.1, 1],
				}}
				...
				<motion.div
					className='text-5xl text-amber-600 font-serif select-none'
					animate={{
						opacity: [0.5, 1, 0.5],
						scale: [0.9, 1.1, 0.9],
					}}
